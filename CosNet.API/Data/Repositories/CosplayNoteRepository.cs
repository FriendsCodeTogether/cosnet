...
{
    public class CosplayItemNoteRepository : ICosplayItemNoteRepository
    {
        ...
        public IEnumerable<CosplayItemNote> GetCosplayItemNotes(Guid cosplayId)
        {
            return _dbContext.CosplayItemNotes.Where(c => c.CosplayId == cosplayId);
        }
